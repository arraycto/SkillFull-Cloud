...
import indi.zxiaozhou.skillfull.auth.modules.common.service.mapstruct.dto.CommonUserIdentityDtoMap;
import indi.zxiaozhou.skillfull.auth.modules.common.service.mapstruct.dto.CommonUserIdentityPageDtoMap;
import indi.zxiaozhou.skillfull.auth.modules.common.service.mapstruct.vo.CommonUserIdentityPageVoMap;
import indi.zxiaozhou.skillfull.auth.modules.common.service.mapstruct.vo.CommonUserIdentityQueryVoMap;
import indi.zxiaozhou.skillfull.auth.modules.common.service.mapstruct.vo.CommonUserIdentityVoMap;
...
public class CommonUserIdentityServiceImpl extends ServiceImpl<CommonUserIdentityMapper, CommonUserIdentityEntity> implements ICommonUserIdentityService {
    ...
    public void save(CommonUserIdentityVo vo) throws RuntimeException {
        CommonUserIdentityEntity entity = voMap.toEntity(vo);
    ...
    public PageDto<CommonUserIdentityPageDto> page(CommonUserIdentityPageVo vo) throws RuntimeException {
        LambdaQueryWrapper<CommonUserIdentityEntity> queryWrapper = new LambdaQueryWrapper<>(pageVoMap.toEntity(vo));
