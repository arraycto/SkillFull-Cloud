...
/**
 * 用户-代理人表(CommonUserAgent)Dto与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2021-02-12 19:40:45
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface CommonUserAgentDtoMap extends BaseDtoMap<CommonUserAgentDto, CommonUserAgentEntity> {
}