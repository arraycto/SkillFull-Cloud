...
/**
 * 数据映射表(CommonDataMap)QueryVo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2021-02-12 19:40:23
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface CommonDataMapQueryVoMap extends BaseVoMap<CommonDataMapQueryVo, CommonDataMapEntity> {
}