...
/**
 * 用户-代理人表(CommonUserAgent)QueryVo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2021-02-12 19:40:49
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface CommonUserAgentQueryVoMap extends BaseVoMap<CommonUserAgentQueryVo, CommonUserAgentEntity> {
}