...
/**
 * 用户-代理人表(CommonUserAgent)Vo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2021-02-12 19:40:47
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface CommonUserAgentVoMap extends BaseVoMap<CommonUserAgentVo, CommonUserAgentEntity> {
}