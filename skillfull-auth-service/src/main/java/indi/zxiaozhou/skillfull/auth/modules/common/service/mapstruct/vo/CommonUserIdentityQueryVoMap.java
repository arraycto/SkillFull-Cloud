...
/**
 * 实名信息表(CommonUserIdentity)QueryVo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2021-02-12 19:41:48
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface CommonUserIdentityQueryVoMap extends BaseVoMap<CommonUserIdentityQueryVo, CommonUserIdentityEntity> {
}