...
/**
 * 实名信息表(CommonUserIdentity)Vo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2021-02-12 19:41:46
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface CommonUserIdentityVoMap extends BaseVoMap<CommonUserIdentityVo, CommonUserIdentityEntity> {
}