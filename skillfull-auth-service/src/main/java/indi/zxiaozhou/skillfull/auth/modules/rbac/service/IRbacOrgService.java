...
public interface IRbacOrgService extends BaseService<RbacOrgEntity> {
     ...
     * @return List<RbacOrgTreePageDto> ${@link  List<RbacOrgTreePageDto>}
     * @throws RuntimeException ${@link RuntimeException}
     * @author zxiaozhou
     * @date 2021-01-30 23:25
     */
    List<RbacOrgTreePageDto> getChildren(String parentId) throws RuntimeException;
