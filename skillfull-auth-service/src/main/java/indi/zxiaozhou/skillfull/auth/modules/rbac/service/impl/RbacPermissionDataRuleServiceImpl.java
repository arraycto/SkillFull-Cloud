...
import indi.zxiaozhou.skillfull.auth.modules.rbac.service.mapstruct.dto.RbacPermissionDataRuleDtoMap;
import indi.zxiaozhou.skillfull.auth.modules.rbac.service.mapstruct.dto.RbacPermissionDataRulePageDtoMap;
import indi.zxiaozhou.skillfull.auth.modules.rbac.service.mapstruct.vo.RbacPermissionDataRulePageVoMap;
import indi.zxiaozhou.skillfull.auth.modules.rbac.service.mapstruct.vo.RbacPermissionDataRuleQueryVoMap;
import indi.zxiaozhou.skillfull.auth.modules.rbac.service.mapstruct.vo.RbacPermissionDataRuleVoMap;
...
public class RbacPermissionDataRuleServiceImpl extends ServiceImpl<RbacPermissionDataRuleMapper, RbacPermissionDataRuleEntity> implements IRbacPermissionDataRuleService {
    ...
    public void save(RbacPermissionDataRuleVo vo) throws RuntimeException {
        RbacPermissionDataRuleEntity entity = voMap.toEntity(vo);
    ...
    public PageDto<RbacPermissionDataRulePageDto> page(RbacPermissionDataRulePageVo vo) throws RuntimeException {
        LambdaQueryWrapper<RbacPermissionDataRuleEntity> queryWrapper = new LambdaQueryWrapper<>(pageVoMap.toEntity(vo));
