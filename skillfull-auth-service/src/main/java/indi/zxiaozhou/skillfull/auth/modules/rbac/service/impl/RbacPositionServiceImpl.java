...
import indi.zxiaozhou.skillfull.auth.modules.rbac.service.mapstruct.dto.RbacPositionDtoMap;
import indi.zxiaozhou.skillfull.auth.modules.rbac.service.mapstruct.dto.RbacPositionPageDtoMap;
import indi.zxiaozhou.skillfull.auth.modules.rbac.service.mapstruct.vo.RbacPositionPageVoMap;
import indi.zxiaozhou.skillfull.auth.modules.rbac.service.mapstruct.vo.RbacPositionQueryVoMap;
import indi.zxiaozhou.skillfull.auth.modules.rbac.service.mapstruct.vo.RbacPositionVoMap;
...
public class RbacPositionServiceImpl extends ServiceImpl<RbacPositionMapper, RbacPositionEntity> implements IRbacPositionService {
    ...
    public void save(RbacPositionVo vo) throws RuntimeException {
        RbacPositionEntity entity = voMap.toEntity(vo);
        // 数据重复性校验
