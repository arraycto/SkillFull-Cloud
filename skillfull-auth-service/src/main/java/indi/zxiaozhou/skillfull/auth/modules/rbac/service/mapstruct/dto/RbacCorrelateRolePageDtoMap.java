...
import indi.zxiaozhou.skillfull.auth.modules.rbac.service.dto.RbacCorrelateRolePageDto;
import indi.zxiaozhou.skillfull.coremvc.base.service.mapstruct.BaseDtoMap;
import org.mapstruct.Mapper;
import org.mapstruct.ReportingPolicy;

/**
 * 角色关联关系表(RbacCorrelateRole)PageDto与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2020-11-02 09:37:29
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface RbacCorrelateRolePageDtoMap extends BaseDtoMap<RbacCorrelateRolePageDto, RbacCorrelateRoleEntity> {
}