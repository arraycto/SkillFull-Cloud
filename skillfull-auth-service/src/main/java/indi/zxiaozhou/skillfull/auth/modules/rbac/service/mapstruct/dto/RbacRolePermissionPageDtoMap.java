...
import indi.zxiaozhou.skillfull.auth.modules.rbac.service.dto.RbacRolePermissionPageDto;
import indi.zxiaozhou.skillfull.coremvc.base.service.mapstruct.BaseDtoMap;
import org.mapstruct.Mapper;
import org.mapstruct.ReportingPolicy;

/**
 * 角色-权限表(RbacRolePermission)PageDto与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2020-10-08 13:29:16
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface RbacRolePermissionPageDtoMap extends BaseDtoMap<RbacRolePermissionPageDto, RbacRolePermissionEntity> {
}