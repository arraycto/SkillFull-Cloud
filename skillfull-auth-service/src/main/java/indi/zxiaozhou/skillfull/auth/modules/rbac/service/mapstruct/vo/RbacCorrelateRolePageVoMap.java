...
import indi.zxiaozhou.skillfull.auth.modules.rbac.controller.vo.RbacCorrelateRolePageVo;
...
/**
 * 角色关联关系表(RbacCorrelateRole)PageVo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2020-11-02 09:37:29
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface RbacCorrelateRolePageVoMap extends BaseVoMap<RbacCorrelateRolePageVo, RbacCorrelateRoleEntity> {
}