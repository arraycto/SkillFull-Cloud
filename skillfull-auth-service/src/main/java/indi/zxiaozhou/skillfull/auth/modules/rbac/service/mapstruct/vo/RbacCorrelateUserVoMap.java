...
import indi.zxiaozhou.skillfull.auth.modules.rbac.controller.vo.RbacCorrelateUserVo;
...
/**
 * 用户关联关系表(RbacCorrelateUser)Vo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2020-11-02 09:37:36
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface RbacCorrelateUserVoMap extends BaseVoMap<RbacCorrelateUserVo, RbacCorrelateUserEntity> {
}