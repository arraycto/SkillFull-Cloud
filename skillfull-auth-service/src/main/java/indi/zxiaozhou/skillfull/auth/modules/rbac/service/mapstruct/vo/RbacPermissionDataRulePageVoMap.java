...
/**
 * 权限数据填值规则表(RbacPermissionDataRule)PageVo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2020-11-02 09:41:31
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface RbacPermissionDataRulePageVoMap extends BaseVoMap<RbacPermissionDataRulePageVo, RbacPermissionDataRuleEntity> {
}