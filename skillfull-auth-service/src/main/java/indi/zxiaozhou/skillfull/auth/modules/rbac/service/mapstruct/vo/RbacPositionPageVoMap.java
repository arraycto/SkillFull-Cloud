...
/**
 * 职位表(RbacPosition)PageVo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2021-01-19 18:18:03
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface RbacPositionPageVoMap extends BaseVoMap<RbacPositionPageVo, RbacPositionEntity> {
}