...
import indi.zxiaozhou.skillfull.auth.modules.rbac.controller.vo.RbacRolePermissionPageVo;
...
/**
 * 角色-权限表(RbacRolePermission)PageVo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2020-10-08 13:29:16
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface RbacRolePermissionPageVoMap extends BaseVoMap<RbacRolePermissionPageVo, RbacRolePermissionEntity> {
}