...
/**
 * 角色-权限表(RbacRolePermission)QueryVo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2020-10-08 13:29:16
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface RbacRolePermissionQueryVoMap extends BaseVoMap<RbacRolePermissionQueryVo, RbacRolePermissionEntity> {
}