...
import indi.zxiaozhou.skillfull.auth.modules.rbac.controller.vo.RbacRoleQueryVo;
...
/**
 * 角色表(RbacRole)QueryVo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2020-10-08 13:44:05
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface RbacRoleQueryVoMap extends BaseVoMap<RbacRoleQueryVo, RbacRoleEntity> {
}