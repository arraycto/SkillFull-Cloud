...
import indi.zxiaozhou.skillfull.auth.modules.rbac.controller.vo.RbacUserQueryVo;
...
/**
 * 用户表(User)QueryVo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2020-09-26 17:16:18
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface RbacUserQueryVoMap extends BaseVoMap<RbacUserQueryVo, RbacUserEntity> {
}