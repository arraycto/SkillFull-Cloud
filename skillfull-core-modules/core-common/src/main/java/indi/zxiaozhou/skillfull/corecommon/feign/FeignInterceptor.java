...
// +----------------------------------------------------------------------
package indi.zxiaozhou.skillfull.corecommon.feign;


import feign.RequestInterceptor;
import feign.RequestTemplate;
import indi.zxiaozhou.skillfull.corecommon.feign.strategy.header.ContextHeaderStrategy;
import indi.zxiaozhou.skillfull.corecommon.feign.strategy.safety.ContextSafetyStrategy;
...
public class FeignInterceptor implements RequestInterceptor {
    ...
    public void apply(RequestTemplate template) {
        Map<String, Collection<String>> headers = new LinkedHashMap<>(template.headers());
