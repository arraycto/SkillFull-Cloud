...
import indi.zxiaozhou.skillfull.corecommon.constant.CommonConstant;
...
public class RedisConfig {
     ...
     * redis配置
     *
     * @param factory ${@link ReactiveRedisConnectionFactory}
     * @return ReactiveStringRedisTemplate ${@link ReactiveStringRedisTemplate}
     * @author zxiaozhou
     * @date 2021-01-08 13:10
     */
    @Bean
    @Primary
