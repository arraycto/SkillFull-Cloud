 ...
 */
@Getter
@ConstantType("PredicateType")
public enum PredicateType implements ISuperType {
    /**
     * 某时间后
     */
    ...
    PredicateType(String predicateType, String predicateTypeDescribe, String predicateTypeClassName) {
    ...
    public static boolean isHaveByType(String predicateType) {
        PredicateType[] values = PredicateType.values();
        for (PredicateType value : values) {
