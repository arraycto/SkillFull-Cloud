...
@Slf4j
@Component
public class AppendSignGatewayFilterFactory extends AbstractGatewayFilterFactory<AppendSignGatewayFilterFactory.Config> {
    ...
    public AppendSignGatewayFilterFactory() {
        super(AppendSignGatewayFilterFactory.Config.class);
    }
    ...
    private class AuthorizeGatewayFilter implements GatewayFilter, Ordered {
        ...
        private GatewayFilterFactory<AppendSignGatewayFilterFactory.Config> gatewayFilterFactory;
        ...
        public void setFactory(GatewayFilterFactory<AppendSignGatewayFilterFactory.Config> gatewayFilterFactory) {
