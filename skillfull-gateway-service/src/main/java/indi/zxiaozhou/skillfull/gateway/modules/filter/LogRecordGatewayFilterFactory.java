...
public class LogRecordGatewayFilterFactory extends AbstractGatewayFilterFactory<LogRecordGatewayFilterFactory.Config> {
    ...
    public LogRecordGatewayFilterFactory() {
        super(LogRecordGatewayFilterFactory.Config.class);
    }
    ...
    private class AuthorizeGatewayFilter implements GatewayFilter, Ordered {
        ...
        private GatewayFilterFactory<LogRecordGatewayFilterFactory.Config> gatewayFilterFactory;
        ...
        public void setFactory(GatewayFilterFactory<LogRecordGatewayFilterFactory.Config> gatewayFilterFactory) {
