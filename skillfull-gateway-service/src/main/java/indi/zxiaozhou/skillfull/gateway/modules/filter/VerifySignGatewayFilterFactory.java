...
public class VerifySignGatewayFilterFactory extends AbstractGatewayFilterFactory<VerifySignGatewayFilterFactory.Config> {
    ...
    public VerifySignGatewayFilterFactory() {
        super(VerifySignGatewayFilterFactory.Config.class);
    }
    ...
    private class AuthorizeGatewayFilter implements GatewayFilter, Ordered {
        ...
        private GatewayFilterFactory<VerifySignGatewayFilterFactory.Config> gatewayFilterFactory;
        ...
        public void setFactory(GatewayFilterFactory<VerifySignGatewayFilterFactory.Config> gatewayFilterFactory) {
