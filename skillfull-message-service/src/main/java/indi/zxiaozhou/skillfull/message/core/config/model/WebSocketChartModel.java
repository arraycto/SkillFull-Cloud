...
@ToString
@EqualsAndHashCode
public class WebSocketChartModel implements Serializable {
    ...
    public WebSocketChartModel(FluxSink<WebSocketMessage> sink, WebSocketSession session, String token) {
        this.sink = sink;
