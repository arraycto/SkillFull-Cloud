...
public interface IManageSendRecordService extends BaseService<ManageSendRecordEntity> {
     ...
     * @date 2021-02-12 19:57:38
     */
    PageDto<ManageSendRecordPageDto> page(ManageSendRecordPageVo vo) throws RuntimeException;


    /**
     * 条件查询多条
     *
     * @param vo ${@link ManageSendRecordQueryVo} 消息发送记录表条件查询Vo
     * @return List<ManageSendRecordDto> ${@link List<ManageSendRecordDto>} 查询结果
     * @throws RuntimeException ${@link RuntimeException}
     * @author zxiaozhou
     * @date 2021-02-12 19:57:38
     */
    List<ManageSendRecordDto> selectListByModel(ManageSendRecordQueryVo vo) throws RuntimeException;
