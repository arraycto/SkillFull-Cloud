...
import indi.zxiaozhou.skillfull.message.modules.manage.service.mapstruct.dto.ManageAnnouncementDtoMap;
import indi.zxiaozhou.skillfull.message.modules.manage.service.mapstruct.dto.ManageAnnouncementPageDtoMap;
import indi.zxiaozhou.skillfull.message.modules.manage.service.mapstruct.vo.ManageAnnouncementPageVoMap;
import indi.zxiaozhou.skillfull.message.modules.manage.service.mapstruct.vo.ManageAnnouncementQueryVoMap;
import indi.zxiaozhou.skillfull.message.modules.manage.service.mapstruct.vo.ManageAnnouncementVoMap;
...
public class ManageAnnouncementServiceImpl extends ServiceImpl<ManageAnnouncementMapper, ManageAnnouncementEntity> implements IManageAnnouncementService {
    ...
    public void save(ManageAnnouncementVo vo) throws RuntimeException {
        ManageAnnouncementEntity entity = voMap.toEntity(vo);
    ...
    public PageDto<ManageAnnouncementPageDto> page(ManageAnnouncementPageVo vo) throws RuntimeException {
        LambdaQueryWrapper<ManageAnnouncementEntity> queryWrapper = new LambdaQueryWrapper<>(pageVoMap.toEntity(vo));
