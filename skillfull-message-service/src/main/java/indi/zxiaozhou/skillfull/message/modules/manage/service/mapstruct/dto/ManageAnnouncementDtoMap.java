...
/**
 * 系统通告管理(ManageAnnouncement)Dto与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2021-02-12 19:57:11
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface ManageAnnouncementDtoMap extends BaseDtoMap<ManageAnnouncementDto, ManageAnnouncementEntity> {
}