...
/**
 * 消息发送记录表(ManageSendRecord)PageDto与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2021-02-12 19:57:41
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface ManageSendRecordPageDtoMap extends BaseDtoMap<ManageSendRecordPageDto, ManageSendRecordEntity> {
}