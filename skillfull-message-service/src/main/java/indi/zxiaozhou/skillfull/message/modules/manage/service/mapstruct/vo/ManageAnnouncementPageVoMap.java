...
/**
 * 系统通告管理(ManageAnnouncement)PageVo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2021-02-12 19:57:13
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface ManageAnnouncementPageVoMap extends BaseVoMap<ManageAnnouncementPageVo, ManageAnnouncementEntity> {
}