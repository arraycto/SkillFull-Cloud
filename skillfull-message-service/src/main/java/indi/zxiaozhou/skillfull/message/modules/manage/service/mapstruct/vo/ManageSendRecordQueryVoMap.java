...
/**
 * 消息发送记录表(ManageSendRecord)QueryVo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2021-02-12 19:57:44
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface ManageSendRecordQueryVoMap extends BaseVoMap<ManageSendRecordQueryVo, ManageSendRecordEntity> {
}