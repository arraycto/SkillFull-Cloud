...
/**
 * 消息发送记录表(ManageSendRecord)Vo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2021-02-12 19:57:42
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface ManageSendRecordVoMap extends BaseVoMap<ManageSendRecordVo, ManageSendRecordEntity> {
}