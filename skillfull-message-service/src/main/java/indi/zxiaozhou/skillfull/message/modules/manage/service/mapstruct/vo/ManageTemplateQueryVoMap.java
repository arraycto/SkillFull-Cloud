...
/**
 * 消息模板(ManageTemplate)QueryVo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2021-02-12 19:58:21
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface ManageTemplateQueryVoMap extends BaseVoMap<ManageTemplateQueryVo, ManageTemplateEntity> {
}