...
/**
 * 消息模板(ManageTemplate)Vo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2021-02-12 19:58:19
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface ManageTemplateVoMap extends BaseVoMap<ManageTemplateVo, ManageTemplateEntity> {
}