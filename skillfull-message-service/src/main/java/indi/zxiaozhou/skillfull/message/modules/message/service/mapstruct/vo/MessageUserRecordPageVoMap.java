...
/**
 * 用户消息记录(MessageUserRecord)PageVo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2021-01-26 16:48:45
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface MessageUserRecordPageVoMap extends BaseVoMap<MessageUserRecordPageVo, MessageUserRecordEntity> {
}