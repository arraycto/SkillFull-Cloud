...
/**
 * 用户消息记录(MessageUserRecord)Vo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2021-01-26 16:48:44
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface MessageUserRecordVoMap extends BaseVoMap<MessageUserRecordVo, MessageUserRecordEntity> {
}