...
import indi.zxiaozhou.skillfull.storage.modules.oss.service.mapstruct.dto.OssFileDtoMap;
import indi.zxiaozhou.skillfull.storage.modules.oss.service.mapstruct.dto.OssFileUploadSuccessMap;
import indi.zxiaozhou.skillfull.storage.modules.oss.service.mapstruct.vo.OssFileVoUploadFailMap;
...
public class OssFileServiceImpl extends ServiceImpl<OssFileMapper, OssFileEntity> implements IOssFileService {
    ...
    public OssFileUploadBatchDto uploadUrlBatch(List<OssFileVo> vos) throws RuntimeException {
        ...
        for (OssFileVo vo : vos) {
            try {
                ...
                OssFileUploadBatchDto.UploadSuccess uploadSuccess = uploadSuccessMap.toEntity(localFileDto);
                ...
                e.printStackTrace();
                type = 1;
                OssFileUploadBatchDto.UploadFail uploadFail = uploadFailMap.toEntity(vo);
    ...
    public OssFileDto getById(String ossFileId, boolean getUrl) throws RuntimeException {
        ...
        OssFileDto ossFileDto = dtoMap.toDto(byId);
        if (getUrl) {
