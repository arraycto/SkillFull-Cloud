...
import indi.zxiaozhou.skillfull.system.modules.common.service.mapstruct.dto.CommonCategoryDtoMap;
import indi.zxiaozhou.skillfull.system.modules.common.service.mapstruct.dto.CommonCategoryPageDtoMap;
import indi.zxiaozhou.skillfull.system.modules.common.service.mapstruct.dto.CommonCategoryTreeDtoMap;
import indi.zxiaozhou.skillfull.system.modules.common.service.mapstruct.vo.CommonCategoryVoMap;
...
public class CommonCategoryServiceImpl extends ServiceImpl<CommonCategoryMapper, CommonCategoryEntity> implements ICommonCategoryService {
    ...
    public void save(CommonCategoryVo vo) throws RuntimeException {
        CommonCategoryEntity entity = voMap.toEntity(vo);
    ...
    public List<CommonCategoryTreeDto> selectTreeListByCommonCode(String categoryCommonCode) throws RuntimeException {
        ...
        List<CommonCategoryTreeDto> commonCategoryTreeDtos = treeDtoMap.toDto(commonCategoryDtos);
        // 获取根节点
    ...
    public List<CommonCategoryPageDto> selectPageChildren(String parentId) throws RuntimeException {
        ...
        List<CommonCategoryEntity> list = this.list(lambdaQueryWrapper);
        List<CommonCategoryPageDto> commonCategoryPageDtos = pageDtoMap.toDto(list);
        // 查询是否有下级
    ...
    public List<CommonCategoryTreeDto> selectAllTree() throws RuntimeException {
        ...
        List<CommonCategoryEntity> list = this.list(lambdaQueryWrapper);
        List<CommonCategoryTreeDto> rootList = treeDtoMap.toDto(dtoMap.toDto(list));
        // 获取子节点
        if (CollectionUtil.isNotEmpty(rootList)) {
            ...
            List<CommonCategoryTreeDto> subList = treeDtoMap.toDto(dtoMap.toDto(list));
            // 构建树
