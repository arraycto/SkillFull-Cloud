...
import indi.zxiaozhou.skillfull.system.modules.common.service.mapstruct.dto.CommonDictDtoMap;
import indi.zxiaozhou.skillfull.system.modules.common.service.mapstruct.vo.CommonDictVoMap;
...
public class CommonDictServiceImpl extends ServiceImpl<CommonDictMapper, CommonDictEntity> implements ICommonDictService {
    ...
    public void save(CommonDictVo vo) throws RuntimeException {
        CommonDictEntity entity = voMap.toEntity(vo);
