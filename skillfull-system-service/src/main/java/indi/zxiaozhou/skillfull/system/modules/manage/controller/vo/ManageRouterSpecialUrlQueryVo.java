...
@ApiModel
public class ManageRouterSpecialUrlQueryVo implements Serializable {
    private static final long serialVersionUID = 895858881748830122L;

    @ApiModelProperty(name = "routeSpecialId", value = "特殊路由id")
