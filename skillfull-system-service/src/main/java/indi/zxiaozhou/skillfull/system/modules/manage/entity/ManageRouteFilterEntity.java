...
public class ManageRouteFilterEntity extends BaseEntity {
    private static final long serialVersionUID = -56079802070683892L;
    ...
    @ApiModelProperty(name = "rules", value = "过滤器规则:[{ruleName:规则名称,ruleValue:规则值}]")
