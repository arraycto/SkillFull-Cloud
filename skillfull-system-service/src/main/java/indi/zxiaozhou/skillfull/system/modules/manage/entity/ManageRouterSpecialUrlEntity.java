...
/**
 * 路由特殊地址(ManageRouterSpecialUrl)Entity
 *
 * @author zxiaozhou
 * @date 2021-02-12 20:29:02
 * @since JDK1.8
 */
@Getter
@Setter
...
@TableName("sys_manage_router_special_url")
public class ManageRouterSpecialUrlEntity extends BaseEntity {
    private static final long serialVersionUID = 692105204310523671L;

    @TableId
    private String routeSpecialId;

    @ApiModelProperty(name = "routeId", value = "路由id")
    private String routeId;

    @ApiModelProperty(name = "filterId", value = "处理过滤器类型")
    private String filterId;

    @ApiModelProperty(name = "serviceUrl", value = "后端服务地址")
