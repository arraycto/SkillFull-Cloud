...
public class CustomNacosNamingServiceImpl implements ICustomNacosNamingService {
    ...
    @Autowired
    public CustomNacosNamingServiceImpl(NacosDiscoveryProperties properties) throws NacosException {
        init(properties);
    }
...
//        InitUtils.initWebRootContext();
    ...
    @Override
    public List<Instance> getAllInstances(String serviceName, String groupName, List<String> clusters) throws RuntimeException {
        ...
        try {
            ...
            e.printStackTrace();
            log.error("------------INacosServiceImpl------------>getAllInstances:serviceName-{},groupName-{},errMsg-{}", serviceName, groupName, e.getErrMsg());
