...
/**
 * 路由特殊地址(ManageRouterSpecialUrl)QueryVo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2020-12-31 22:51:09
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface ManageRouterSpecialUrlQueryVoMap extends BaseVoMap<ManageRouterSpecialUrlQueryVo, ManageRouterSpecialUrlEntity> {
}