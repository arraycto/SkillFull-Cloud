...
/**
 * 路由特殊地址(ManageRouterSpecialUrl)Vo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2020-12-31 22:51:02
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface ManageRouterSpecialUrlVoMap extends BaseVoMap<ManageRouterSpecialUrlVo, ManageRouterSpecialUrlEntity> {
}