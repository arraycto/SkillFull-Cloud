...
/**
 * 服务管理(ManageService)PageVo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2020-12-31 23:06:34
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface ManageServicePageVoMap extends BaseVoMap<ManageServicePageVo, ManageServiceEntity> {
}