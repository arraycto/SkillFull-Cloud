...
import indi.zxiaozhou.skillfull.system.modules.manage.controller.vo.ManageServiceQueryVo;
import indi.zxiaozhou.skillfull.system.modules.manage.entity.ManageServiceEntity;
import org.mapstruct.Mapper;
import org.mapstruct.ReportingPolicy;

/**
 * 服务管理(ManageService)QueryVo与Entity相互转换
 *
 * @author zxiaozhou
 * @since 2020-09-13 17:50:24
 */
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface ManageServiceQueryVoMap extends BaseVoMap<ManageServiceQueryVo, ManageServiceEntity> {
}